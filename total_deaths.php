<?php
    ...
    {
        $query = mysqli_query($koneksi,"select total_death from angka_penderita where id='$country'");
        $row = $query->fetch_array();
        $jumlah_kasus[] = $row['total_death'];
    }
    ...
    while($row2 = mysqli_fetch_array($negara)){
        ...
        $query = mysqli_query($koneksi,"select total_death from angka_penderita where id='".$row2['id']."'");
        $row2 = $query->fetch_array();
        $jumlah_kasus2[] = $row2['total_death'];
    }
?>
...
<body>
	<div style="width: 800px;height: 800px">
		<h3>Line Chart Total Deaths</h3>
        <canvas id="lineChart"></canvas>
        <h3>Bar Chart Total Deaths</h3>
		<canvas id="barChart"></canvas>
	</div>
    <br><br><br><br><br><br>
    <div id="canvas-holder" style="width:60%">
		<h3>Pie Chart Total Deaths</h3>
		<canvas id="piechart"></canvas>
	</div>
    <div id="canvas-holder" style="width:60%">
        <h3>Doughnut Chart Total Deaths</h3>
