<?php
    ...
    {
        $query = mysqli_query($koneksi,"select active_case from angka_penderita where id='$country'");
        $row = $query->fetch_array();
        $jumlah_kasus[] = $row['active_case'];
    }
    ...
    while($row2 = mysqli_fetch_array($negara)){
        ...
        $query = mysqli_query($koneksi,"select active_case from angka_penderita where id='".$row2['id']."'");
        $row2 = $query->fetch_array();
        $jumlah_kasus2[] = $row2['active_case'];
    }
?>
...
<body>
	<div style="width: 800px;height: 800px">
		<h3>Line Chart Active Cases</h3>
        <canvas id="lineChart"></canvas>
        <h3>Bar Chart Active Cases</h3>
		<canvas id="barChart"></canvas>
	</div>
    <br><br><br><br><br><br>
    <div id="canvas-holder" style="width:60%">
		<h3>Pie Chart Active Cases</h3>
		<canvas id="piechart"></canvas>
	</div>
    <div id="canvas-holder" style="width:60%">
        <h3>Doughnut Chart Active Cases</h3>
