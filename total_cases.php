<?php
    ...
    while($row2 = mysqli_fetch_array($negara)){
        ...
        $query = mysqli_query($koneksi,"select total_case from angka_penderita where id='".$row2['id']."'");
        $row2 = $query->fetch_array();
        $jumlah_kasus2[] = $row2['total_case'];
    }
?>
...
<body>
	<div style="width: 800px;height: 800px">
		<h3>Line Chart Total Cases</h3>
        <canvas id="lineChart"></canvas>
        <h3>Bar Chart Total Cases</h3>
    ...
    <div id="canvas-holder" style="width:60%">
        <h3>Doughnut Chart Total Cases</h3>
